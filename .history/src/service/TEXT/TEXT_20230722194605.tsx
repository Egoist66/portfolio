...
function Text({_color, font_size, type, centered, children} : TextPropsType){
    ...
    switch(type){
        case 'p':
            return <StyledParagraph centered={centered} font_size={font_size} _color={_color}>{children}</StyledParagraph>
        case 'h2':
            return <StyledTitleH2  centered={centered}  font_size={font_size} _color={_color}>{children}</StyledTitleH2>
        case 'h1':
            return <StyledTitleH1  centered={centered} font_size={font_size} _color={_color}>{children}</StyledTitleH1>
        default:
